...
Inventory$$module$js$inventory.prototype.addItem=function(a){var b=this,c=this.items.findIndex(function(a){return!a});this.items[c]=a;if(a.title){var d=new Text$$module$js$text(this.micrio,"Picked up "+a.title,0,-12,"#00ff00");setTimeout(function(){return d.remove()},4E3)}a.audio&&a.audio.fileUrl&&(this._audio.src=a.audio.fileUrl,this._audio.play());a.remove();c=this.game.currentLevel.markers.findIndex(function(b){return b.id==a.id});this.game.currentLevel.markers.splice(c,1);a._images=a.images.map(function(a){var b=
new Image;b.src=a.src.replace(/\.(jpg|png)/,".64.$1");b.crossOrigin=!0;return b});a._images[0]?a._images[0].onload=function(){b.showHide()}:this.showHide()};Inventory$$module$js$inventory.prototype.showHide=function(){var a=this;this.draw();this.show();setTimeout(function(){return a.hide()},4E3)};Inventory$$module$js$inventory.prototype.removeItem=function(a){var b=this.items.findIndex(function(b){return b.id==a});0<=b&&(this.items.splice(b,1),this.draw())};
