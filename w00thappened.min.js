...
loaderbar:!1,noToolbar:!0});this.b=this.a.container;this.b.addEventListener("click",this.onclick.bind(this));this.b.addEventListener("mousemove",this.H.bind(this));this.b.addEventListener("load",this.i)};U.prototype.i=function(){this.b.removeEventListener("load",this.i);this.b.addEventListener("metadata",this.l);this.s=new Q(this);this.l(this.a)};
